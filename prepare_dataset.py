...
def main(
    ...
    passages_path = os.path.join(rag_example_args.output_dir, "brazil_knowledge_dataset")
    ...
    # And save the index
    index_path = os.path.join(rag_example_args.output_dir, "brazil_knowledge_dataset_hnsw_index.faiss")
